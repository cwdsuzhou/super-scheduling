...
func autoConvert_v1beta1_Configuration_To_config_Configuration(in *Configuration, out *config.Configuration, s conversion.Scope) error {
	...
	if err := v1.Convert_Pointer_string_To_string(&in.KubeConfig, &out.KubeConfig, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_Configuration_To_v1beta1_Configuration(in *config.Configuration, out *Configuration, s conversion.Scope) error {
	...
	if err := v1.Convert_string_To_Pointer_string(&in.KubeConfig, &out.KubeConfig, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_SchedulingArgs_To_config_SchedulingArgs(in *SchedulingArgs, out *config.SchedulingArgs, s conversion.Scope) error {
	...
	if in.ClusterConfiguration != nil {
		...
		*out = make(map[string]config.Configuration, len(*in))
		for key, val := range *in {
			newVal := new(config.Configuration)
			if err := Convert_v1beta1_Configuration_To_config_Configuration(&val, newVal, s); err != nil {
				return err
			}
			(*out)[key] = *newVal
		}
...
func autoConvert_config_SchedulingArgs_To_v1beta1_SchedulingArgs(in *config.SchedulingArgs, out *SchedulingArgs, s conversion.Scope) error {
	...
	if in.ClusterConfiguration != nil {
		...
		*out = make(map[string]Configuration, len(*in))
		for key, val := range *in {
			newVal := new(Configuration)
			if err := Convert_config_Configuration_To_v1beta1_Configuration(&val, newVal, s); err != nil {
				return err
			}
			(*out)[key] = *newVal
		}
