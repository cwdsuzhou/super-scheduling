...
import (
	...
	"github.com/cwdsuzhou/super-scheduling/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type SchedulingV1alpha1Interface interface {
	RESTClient() rest.Interface
	TopologySchedulingPoliciesGetter
}
...
func (c *SchedulingV1alpha1Client) TopologySchedulingPolicies(namespace string) TopologySchedulingPolicyInterface {
	return newTopologySchedulingPolicies(c, namespace)
}
