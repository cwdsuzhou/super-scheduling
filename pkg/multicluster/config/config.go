...
import (
	...
	"k8s.io/klog/v2"
	kubeschedulerconfigv1alpha1 "k8s.io/kube-scheduler/config/v1beta1"
	schedulerappconfig "k8s.io/kubernetes/cmd/kube-scheduler/app/config"
	kubeschedulerconfig "k8s.io/kubernetes/pkg/scheduler/apis/config"
	kubeschedulerscheme "k8s.io/kubernetes/pkg/scheduler/apis/config/scheme"
)

// Config return a multicluster config object
...
func createClients(config componentbaseconfig.ClientConnectionConfiguration,
	...
	client, err := clientset.NewForConfig(restclient.AddUserAgent(kubeConfig, "multicluster"))
	if err != nil {
		return nil, nil, nil, err
	}
...
// NewDefaultComponentConfig return the default configuration of multi multicluster
